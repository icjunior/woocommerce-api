...
@Service
public class GestaoCustomerService {
	...
	@Value("${SUFIXO_CUSTOMER}")
	private String sufixoCustomer;
	...
	private String montaUrl() {
		return baseUrl.concat(sufixoCustomer).concat("consumer_key").concat(ConsumerKey).concat("&consumer_secret")
