...
@Service
public class GestaoOrdersService {
	...
	private String montaUrl() {
		return baseUrl.concat(sufixoOrders).concat("consumer_key").concat(ConsumerKey).concat("&consumer_secret")
